...
import { Text, View, Keyboard, Animated, Platform, StyleSheet } from 'react-native';
      ...
      <View style={styles.container}>
        <Animated.View style={containerImageStyles}>
          ...
          <Animated.Image
            resizeMode="contain"
            style={imageStyles}
            source={require('./images/CoinSwapHD.png')}
          />
        </Animated.View>
        <Text style={styles.text}>Make A Conversion</Text>
      </View>
    );
  }
}
